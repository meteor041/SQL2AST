...
export EVAL_ROOT=${DATA_ROOT}/eval_results
export AST_ROOT=${DATA_ROOT}/eval_results_ast
export REPORT_ROOT=${DATA_ROOT}/reports
export DPO_DATA_ROOT=${DATA_ROOT}/data
export SFT_OUTPUT=${DATA_ROOT}/outputs/sft
export DPO_OUTPUT=${DATA_ROOT}/outputs/dpo
